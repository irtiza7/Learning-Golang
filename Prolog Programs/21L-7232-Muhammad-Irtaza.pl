...
parent(haroon,aslam).
parent(haroon,sakeena).
parent(sadia,aslam).
parent(sadia,sakeena).
parent(hajra,akram).
parent(hajra,naeema).
parent(hafsa,akram).
parent(hafsa,naeema).
parent(hassan,akkram).
parent(hassan,waseema).
parent(zareen,akkram).
parent(zareen,waseema).
parent(qaswa,kashif).
parent(qaswa,shahida).
parent(zarwa,shahida).
parent(zarawa,kashif).
parent(naufil,kashif).
parent(naufil,shahida).
...
daughter(mushtaak,raheela).
daughter(saeeda,raheela).
daughter(mushtaak,waseema).
daughter(saeeda,waseema).
daughter(mushtaak,saima).
daughter(saeeda,saima).
daughter(akram,hajra).
daughter(naeema,hajra).
daughter(akram,hafsa).
daughter(naeema,hafsa).
daughter(aslam,sadia).
daughter(taiJee,sadia).
daughter(akkram,zareen).
daughter(waseema,zareen).
daughter(kashif,qaswa).
daughter(shahida,qaswa).
daughter(kashif,zarwa).
daughter(shahida,zarwa).

finlaw(muslim,mushtaak).
finlaw(akkram,mushtaak).
finlaw(mujahid,mushtaak).
finlaw(raheela,ismail).
finlaw(taiJee,ismail).
finlaw(naeema,ismail).

minlaw(muslim,saeeda).
minlaw(akkram,saeeda).
minlaw(mujahid,saeeda).
minlaw(raheela,sakeena).
minlaw(taiJee,sakeena).
minlaw(naeema,sakeena).
...
humzulf(Person,Humzulf):-
    sali(Person,Sali),husband(Sali,Humzulf).
