...
//
//
//func doSomeAsyncTaskWithCompletion(_ completion: () -> Void) {
//    let images[i] = APICALL(URL)
//    completion()
//}
//
//func foo() {
...
//            group.enter()
//
//            doSomeAsyncTaskWithCompletion {
//                group.leave()
//            }
//        }
//    }
//    group.notify(queue: .main, work: <#T##DispatchWorkItem#>)
//}
//
//func foo() {
